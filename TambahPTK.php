...
//end Langkah 1 : pesan jika form belum diisi (validasi
    ...
    if(isset($_POST['simpan'])){
        ...
        if (!empty($id_PTK) and !empty($nama_PTK) and !empty($jk_PTK) and !empty($jabatan_PTK) and !empty($jenis_PTK) and $nama_PTK_valid) {
            
            /*Proses penyimpanan ke database */
            $input="INSERT INTO tb_ptk VALUES ('$id_PTK','$nama_PTK','$jk_PTK','$jabatan_PTK','$jenis_PTK')";
            ...
            if($query){
                ...
                echo "<script>location='TambahPTK.php'</script>";
            }
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Tambah Data Pendidik dan Tenaga Kependidikan</h1>
</div>
        <!-- DataTales Example -->
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal text-gray-900">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="id_PTK" class="form-control" value="<?php echo $newKode; ?>" placeholder="" readonly>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="nama_PTK" class="form-control" value="<?php echo $nama_PTK; ?>" autofocus placeholder="Masukkan nama PTK">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check">
                                        ...
                                        <!-- End -->
                                        <input class="form-check-input" type="radio" name="jk_PTK" id="gridRadios1" value="L" <?php if ($jk_PTK=='L') {
                                            echo "checked='checked'"; 
                                        }?> >
                                        <label class="form-check-label" for="gridRadios1">L</label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                        <input class="form-check-input" type="radio" name="jk_PTK" id="gridRadios2" value="P" <?php if ($jk_PTK=='P') {
                                            echo "checked='checked'"; 
                                        }?>>
