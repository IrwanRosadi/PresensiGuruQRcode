...
<div class="container-fluid">
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Laporan presensi Kehadiran sesuai jadwal mengajar</h1>
</div>
        <!-- DataTales Example -->
                ...
                <div class="card-body">
                    <div class="table-responsive text-gray-900">
                        ...
                        <div class="row form-group">
                            ...
                            <a href="CetakPresensiMasukMengajar.php" target="_blank" class="btn btn-success "><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print</b></a>
                        </div><br>
                    </form>
                        ...
                        <table align="center" border="0" width="" height="50%">
                            <tr>
                                ...
                                <td><h3 style="text-align: center; line-height: 1.4; font-weight: bold"><font size="4px">
                                    Laporan Presensi Kehadiran Guru Sesuai Jadwal Mengajar</br>SMAN 1 Pringgabaya</font></h3><td>
                            <tr>
                        </table><br>
                            ...
                            <tbody>
                                ...
                                // }else{
                                    $a ="SELECT * FROM tb_ptk WHERE EXISTS
                                        ...
                                        WHERE tb_hasil_presensi.id_PTK = tb_ptk.id_PTK
                                       )";
                                ...
                                <tr align="">
                                    ...
                                    <?php
                                        $get = mysqli_query($koneksi, "SELECT * FROM tb_hasil_presensi WHERE keterangan = 'Hadir' AND id_PTK='$c[id_PTK]'" );
                                        $count = mysqli_num_rows($get);

                                        $get1 = mysqli_query($koneksi, "SELECT * FROM tb_hasil_presensi WHERE keterangan = 'Izin' AND id_PTK='$c[id_PTK]'");
                                        $count1 = mysqli_num_rows($get1);

                                        $get2 = mysqli_query($koneksi, "SELECT * FROM tb_hasil_presensi WHERE keterangan = 'Sakit' AND id_PTK='$c[id_PTK]'");
                                        $count2 = mysqli_num_rows($get2);

                                        $get3 = mysqli_query($koneksi, "SELECT * FROM tb_hasil_presensi WHERE keterangan = 'Alpa' AND id_PTK='$c[id_PTK]'" );
                                        $count3 = mysqli_num_rows($get3);

                                        $get4 = mysqli_query($koneksi, "SELECT * FROM tb_hasil_presensi WHERE keterlambatan = 'Terlambat' AND id_PTK='$c[id_PTK]'" );
