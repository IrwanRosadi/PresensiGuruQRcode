...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Data Jam Mengajar</h1>
      ...
      class="fas fa-download fa-sm text-white-50"></i><strong> Import Data</strong></a> -->
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="TambahJam.php" class="btn btn-outline-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-gray-800" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                // $no = 1;
                                $query = mysqli_query($koneksi, "SELECT * FROM tb_jam");
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <a href="UbahJam.php?id_jam=<?php echo $data['id_jam']?>" class="btn btn-success btn-circle">
                                            <i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i>
                                        </a>&nbsp;&nbsp;&nbsp;
                                        <a href="HapusJam.php?id_jam=<?php echo $data['id_jam']?>" class="btn btn-danger btn-circle" onclick="return confirm('Anda yakin akan menghapus Data Jam ?')">
