                ...
                ?>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                ?>
                                                        ...
                                                        <!-- menampilkan input tb_id_hasil_presesi scr tersembunyi -->
                                                         ...
                                                         <input type="hidden" name="id_kehadiran" value="<?php echo $get3number.$o['id_PTK'];?>">
                                                         <input type="hidden" name="id_jadwal" value="<?php echo $o['id_jadwal']; ?>">
                                                         <input type="hidden" name="keterangan" value="Hadir">
                                
                                                        <p align="right"><button type="submit" name="submit" id="" class="btn btn-success" >Status Aktif</button></p>
                                                        <?php
                    ...
                    ?>
                        ...
                        <form method="POST" action="SimpanPresensi.php" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id_hasil_presensi" value="<?php echo $get3number.$oo['id_PTK']; ?>">
                            <input type="hidden" name="id_jadwal" value="0">                            
                            <input type="hidden" name="keterangan" value="Hadir">
