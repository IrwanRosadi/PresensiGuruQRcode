...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <!-- <a href="Hal_ImportKelas.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
      class="fas fa-download fa-sm text-white-50"></i><strong> Import Data</strong></a> -->
</div>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="TambahKelas.php" class="btn btn-outline-primary">
                        ...
                        <table class="table table-bordered text-gray-800" id="dataTable" width="100%" cellspacing="0">
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <a href="UbahKelas.php?kode_kelas=<?php echo $data['kode_kelas']?>" class="btn btn-success btn-circle">
                                            <i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i>
                                        </a>&nbsp;&nbsp;&nbsp;
                                        <a href="HapusKelas.php?kode_kelas=<?php echo $data['kode_kelas']?>" class="btn btn-danger btn-circle" onclick="return confirm('Anda yakin akan menghapus Data kelas <?php echo $data['nama_kelas'];?> ?')">
