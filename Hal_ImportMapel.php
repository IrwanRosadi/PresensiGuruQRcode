...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-0 text-gray-800">Import Data Mata Pelajaran</h1>
    </div>
            <!-- DataTales Example -->
                    ...
                    <div class="table-responsive">
                        <div class="card-body text-gray-700">
                                <p style="color:;">Sebelum upload data terlebih dahulu <b>download format Excel</b> dibawah, Karena tidak diperkenankan menggunakan formal lain.</p>
                                    <a href="Format_Mata_Pelajaran.xlsx" class="btn btn-success btn-icon-split">
    ...
    <?php
        ...
        if(isset($_POST['preview'])){
            ...
            echo "<form method='post' action='Import_Mapel.php'>";
            ...
            foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                ...
                $kode_mapel     = $row['A']; // Ambil data kode kelas
                $mapel     = $row['B']; // Ambil data nama kelas
                ...
                $kode_mapel_td = ( ! empty($kode_mapel))? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
                $mapel_td = ( ! empty($mapel))? "" : " style='background:  #E07171;'"; // Jika Nama kosong, beri warna merah
                
                
                // Jika salah satu data ada yang kosong
                if(empty($kode_mapel) or empty($mapel)){
