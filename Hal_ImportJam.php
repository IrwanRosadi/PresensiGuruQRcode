...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-0 text-gray-800">Import Data Jam Mengajar</h1>
    </div>
            <!-- DataTales Example -->
                    ...
                    <div class="table-responsive">
                        <div class="card-body text-gray-700">
                                <p style="color:;">Sebelum upload data terlebih dahulu <b>download format Excel</b> dibawah, Karena tidak diperkenankan menggunakan formal lain.</p>
                                    <a href="Format_Jam_mengajar.xlsx" class="btn btn-success btn-icon-split">
    ...
    <?php
        ...
        if(isset($_POST['preview'])){
            ...
            echo "<form method='post' action='Import_JamMengajar.php'>";
            ...
            foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                ...
                $id_jam           = $row['A']; // Ambil data kode kelas
                $jam_mulai        = $row['B']; // Ambil data nama kelas
                $jam_berakhir     = $row['C']; // Ambil data nama kelas
                $keterangan       = $row['D']; // Ambil data nama kelas
                ...
                $id_jam_td = ( ! empty($id_jam))? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
                $jam_mulai_td = ( ! empty($jam_mulai))? "" : " style='background:  #E07171;'"; // Jika Nama kosong, beri warna merah
                $jam_berakhir_td = ( ! empty($jam_berakhir))? "" : " style='background:  #E07171;'";
                $keterangan_td = ( ! empty($keterangan))? "" : " style='background:  #E07171;'";

                // Jika salah satu data ada yang kosong
                if(empty($id_jam) or empty($jam_mulai) or empty($jam_berakhir) or empty($keterangan)){
                    $kosong++; // Tambah 1 variabel $kosong
                }
                
                echo "<tr>";
                    echo "<td".$id_jam_td." >".$id_jam."</td>";
                    echo "<td".$jam_mulai_td." >".$jam_mulai."</td>";
                    echo "<td".$jam_berakhir_td." >".$jam_berakhir."</td>";
