...
//end Langkah 1 : pesan jika form belum diisi (validasi
    ...
    if(isset($_POST['simpan'])){
        ...
        if (!empty($id_jam_pulang) and !empty($jam_pulang)) {
            ...
            $input="INSERT INTO tb_jam_pulang VALUES ('$id_jam_pulang','$jam_pulang')";
            ...
            if($query){
                ...
                echo "<script>location='TambahJamPulang.php'</script>";
            }
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Tambah Data Jam Pulang</h1>
</div>
        <!-- DataTales Example -->
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal text-gray-900">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="id_jam_pulang" class="form-control" value="<?php echo $id_jam_pulang; ?>" placeholder="Masukkan id jam pulang">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="jam_pulang" class="form-control" value="<?php echo $jam_pulang; ?>" placeholder="Masukkan jam Pulang">
                                <?php echo $jam_pulangError;?>
                                <p style="color:#867D7B; font-style:italic;">Jam pulang diisi dengan format jam, menit dan detik. Contoh 12:00:00</p>
                            </div>
                        </div>
